...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://enotarydubai.ae/${lang}/legal-translation/`,
      'x-default': `https://enotarydubai.ae/en/legal-translation/`,
        languages: Object.fromEntries(
        LANGS.map((l) => [`${l}-AE`, `https://enotarydubai.ae/${l}/legal-translation/`])
      ),
    },
  }
}
