...
import { LANGS, type Lang, t, getPageFaq, getServiceFaq } from '@/lib/i18n'
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const titles: Record<string, string> = {
    ...
    ar: 'الأسئلة الشائعة — التوثيق والتوكيلات في دبي | E-Notary Dubai',
...
const SECTIONS = [
  ...
  { key: 'poa_general', label: { en: 'Power of Attorney', ar: 'التوكيلات الرسمية', ru: 'Доверенности', zh: '授权委托书', es: 'Poder Notarial' } },
  ...
  { key: 'overseas_poa', label: { en: 'POA from Outside UAE', ar: 'توكيل من خارج الإمارات', ru: 'Доверенность из-за рубежа', zh: '海外授权书', es: 'POA desde el Exterior' } },
