...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://enotarydubai.ae/${lang}/corporate/board-resolution/`,
      'x-default': `https://enotarydubai.ae/en/corporate/board-resolution/`,
        languages: Object.fromEntries(
        LANGS.map((l) => [`${l}-AE`, `https://enotarydubai.ae/${l}/corporate/board-resolution/`])
      ),
    },
  }
}
