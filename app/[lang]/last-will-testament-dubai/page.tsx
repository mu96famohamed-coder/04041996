...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://enotarydubai.ae/${lang}/last-will-testament-dubai/`,
      'x-default': `https://enotarydubai.ae/en/last-will-testament-dubai/`,
        languages: Object.fromEntries(
        LANGS.map((l) => [`${l}-AE`, `https://enotarydubai.ae/${l}/last-will-testament-dubai/`])
      ),
    },
  }
}
