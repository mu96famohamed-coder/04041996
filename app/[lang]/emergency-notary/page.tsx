...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://enotarydubai.ae/${lang}/emergency-notary/`,
      'x-default': `https://enotarydubai.ae/en/emergency-notary/`,
        languages: Object.fromEntries(
        LANGS.map((l) => [`${l}-AE`, `https://enotarydubai.ae/${l}/emergency-notary/`])
      ),
    },
  }
}
