...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...Object.fromEntries(LANGS.map(l => [HREFLANG_MAP[l], `https://www.enotarydubai.ae/${l}/pricing/`])),
...
const L = {
  ...
  sub:     { en: 'Every service is quoted individually. WhatsApp us — we review the scope, estimated timeline and next steps before you proceed.', ar: 'كل خدمة يُقدَّم لها عرض سعر فردي. راسلنا على واتساب لتأكيد نطاق الخدمة والمدة التقديرية والخطوات التالية.', ru: 'Каждая услуга рассчитывается индивидуально. Напишите в WhatsApp — мы проверим объём, ориентировочный срок и следующие шаги до начала.', zh: '每项服务单独报价。通过WhatsApp联系我们——我们会在开始前审核服务范围、预计时间及后续步骤。', es: 'Cada servicio se cotiza individualmente. Escríbanos por WhatsApp — revisamos alcance, plazo estimado y siguientes pasos antes de comenzar.' },
  ...
  wa_cta:  { en: 'Request a Quote', ar: 'اطلب عرض سعر', ru: 'Запросить расчёт', zh: '申请报价', es: 'Solicitar Cotización' },
