...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const titles: Record<string, string> = {
    ...
    ar: 'المدونة والموارد القانونية في دبي — E-Notary Dubai',
  ...
  const descs: Record<string, string> = {
    ...
    ar: 'أدلة قانونية حول الوكالات والتوثيق وتصديق وزارة الخارجية والخدمات القانونية في دبي والإمارات.',
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...Object.fromEntries(LANGS.map((l) => [HREFLANG_MAP[l], `https://www.enotarydubai.ae/${l}/blog/`])),
