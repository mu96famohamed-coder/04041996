...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://enotarydubai.ae/${lang}/attestation/apostille/`,
      'x-default': `https://enotarydubai.ae/en/attestation/apostille/`,
        languages: Object.fromEntries(
        LANGS.map((l) => [`${l}-AE`, `https://enotarydubai.ae/${l}/attestation/apostille/`])
      ),
    },
  }
}
