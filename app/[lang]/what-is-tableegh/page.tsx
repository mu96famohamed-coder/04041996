...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://enotarydubai.ae/${lang}/what-is-tableegh/`,
      'x-default': `https://enotarydubai.ae/en/what-is-tableegh/`,
        languages: Object.fromEntries(
        LANGS.map((l) => [`${l}-AE`, `https://enotarydubai.ae/${l}/what-is-tableegh/`])
      ),
    },
  }
}
