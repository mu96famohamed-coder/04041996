...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title:       seo?.meta_title?.[lang]       ?? seo?.meta_title?.en,
      description: seo?.meta_description?.[lang] ?? seo?.meta_description?.en,
      url: `https://www.enotarydubai.ae/${lang}/poa-cancellation/`,
    ...
    alternates: {
      ...
      languages: {
        ...Object.fromEntries(LANGS.map((l) => [HREFLANG_MAP[l], `https://www.enotarydubai.ae/${l}/poa-cancellation/`])),
...
export default async function Page({ params }: Props) {
  ...
  return (
    <>
      ...
      relatedServices={relatedFor(lang, '/poa-cancellation')}
      breadcrumb={breadcrumbFor(lang, '/poa-cancellation')}
      />
    </>
  )
}
