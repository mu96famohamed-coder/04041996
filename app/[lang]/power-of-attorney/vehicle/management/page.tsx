...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const seo = (getPageContent('/power-of-attorney/vehicle/management') as any)?.seo
  return {
    ...
    openGraph: {
      title:       seo?.meta_title?.[lang]       ?? seo?.meta_title?.en,
      description: seo?.meta_description?.[lang] ?? seo?.meta_description?.en,
      url: `https://www.enotarydubai.ae/${lang}/power-of-attorney/vehicle/management/`,
...
export default async function Page({ params }: Props) {
  ...
  return (
    <>
      <LegalServiceSchema lang={lang} path="/power-of-attorney/vehicle/management" />
      <ServicePage
        lang={lang}
        title={seo?.h1}
        ...
        faqItems={getPageFaq('/power-of-attorney/vehicle/management')}
        richBlocks={getPageBlocks('/power-of-attorney/vehicle/management')}
      relatedServices={relatedFor(lang, '/power-of-attorney/vehicle/management')}
      breadcrumb={breadcrumbFor(lang, '/power-of-attorney/vehicle/management')}
      />
    </>
  )
}
