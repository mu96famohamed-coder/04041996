...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://enotarydubai.ae/${lang}/power-of-attorney/real-estate/purchase/`,
      'x-default': `https://enotarydubai.ae/en/power-of-attorney/real-estate/purchase/`,
        languages: Object.fromEntries(
        LANGS.map((l) => [`${l}-AE`, `https://enotarydubai.ae/${l}/power-of-attorney/real-estate/purchase/`])
      ),
    },
  }
}
