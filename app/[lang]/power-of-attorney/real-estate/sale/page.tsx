...
export default async function Page({ params }: Props) {
  ...
  return (
    <>
      <LegalServiceSchema lang={lang} path="/power-of-attorney/real-estate/sale" />
      <ServicePage
        lang={lang}
        title={seo?.h1}
      ...
      relatedServices={relatedFor(lang, '/power-of-attorney/real-estate/sale')}
      breadcrumb={breadcrumbFor(lang, '/power-of-attorney/real-estate/sale')}
      />
    </>
  )
}
