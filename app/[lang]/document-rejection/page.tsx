...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://enotarydubai.ae/${lang}/document-rejection/`,
      'x-default': `https://enotarydubai.ae/en/document-rejection/`,
        languages: Object.fromEntries(
        LANGS.map((l) => [`${l}-AE`, `https://enotarydubai.ae/${l}/document-rejection/`])
      ),
    },
  }
}
