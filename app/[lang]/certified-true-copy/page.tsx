...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://enotarydubai.ae/${lang}/certified-true-copy/`,
      'x-default': `https://enotarydubai.ae/en/certified-true-copy/`,
        languages: Object.fromEntries(
        LANGS.map((l) => [`${l}-AE`, `https://enotarydubai.ae/${l}/certified-true-copy/`])
      ),
    },
  }
}
