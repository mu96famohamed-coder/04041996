...
const FOOTER_LINKS = {
  poa: [
    ...
    { href: '/power-of-attorney/company-formation',  en: 'Company Formation POA',ar: 'توكيل تأسيس شركة',       ru: 'Доверенность на регистрацию',    zh: '公司注册授权书', es: 'POA Empresa' },
    ...
    { href: '/poa-cancellation',                     en: 'POA Cancellation',     ar: 'إلغاء التوكيل',          ru: 'Отмена доверенности',            zh: '撤销授权',       es: 'Cancelación POA' },
  ],
  notary: [
  ...
  tenancy: [
    ...
    { href: '/legal-notice/poa-cancellation', en: 'POA Cancellation Notice', ar: 'إنذار إلغاء توكيل',    ru: 'Уведомление об отмене POA', zh: '撤销授权通知',  es: 'Aviso Cancelación' },
  ...
  resources: [
    ...
    { href: '/why-poa-rejected-dubai',   en: 'Why POA Rejected?',     ar: 'لماذا رُفض التوكيل؟',   ru: 'Почему отказали в POA?',    zh: '为何授权被拒？', es: '¿Por Qué Rechazan?' },
